...
# ------------------------- UI Setup -------------------------
st.set_page_config(page_title="Math Worksheet Builder", layout="wide")
st.title("Math Worksheet Builder - ONTARIO")
st.caption("Ontario Curriculum-aligned worksheets with pedagogy-aware features, branding, and accessibility options.")
